...
**•	Project 1:** Collected and visualized data using SQLite, D3 warmup, and OpenRefine <br />

**•	Project 2:** Created graphs and visualizations using D3 and Tableau <br />

**•	Project 3:** Analyzed large data and graphs using Hadoop, Spark, Pig and Azure <br />

**•	Project 4:** Scalable PageRank via Virtual Memory (MMap), Random Forest, Scikit-Learn (used Python) <br />
